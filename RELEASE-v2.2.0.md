...
- 预检不命中时零分配原样通过，不影响正常请求
- 默认开启，未来可通过配置关闭（escape hatch）
...
## 文档更新
- AGENTS.md：第 6 节补 Classify 顺序新不变量、sanitize 逃生门说明
- DEVELOPMENT.md：补 `internal/sanitize/` 包说明，更新 Classify 规则表
- README.md：功能描述补"请求体指纹脱敏"与"错误分类精细化"，版本号更新
